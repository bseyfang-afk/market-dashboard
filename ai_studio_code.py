...
st.markdown(
    f"""<div style="background-color: #1e293b; border-left: 5px solid {health_color}; padding: 12px 18px; border-radius: 6px; margin-bottom: 15px;">
    <span style="color: #ffffff; font-weight: bold;">Market Breadth Health:</span> 
    ...
    <span style="color: #ffffff;">are currently trading <b>ABOVE</b> their {ma_period}-day moving average.</span>
</div>""", 
    unsafe_allow_html=True
)
