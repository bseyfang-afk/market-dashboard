...
with col_nyse:
  ...
  i2.markdown(f"🔴 **Declining:** {nyse_data['dec_stocks_pct']}%")
  i3.markdown(f"⚪ **Unchanged:** {nyse_data['unch_stocks_pct']}%")
...
with col_nasdaq:
  ...
  i2.markdown(f"🔴 **Declining:** {nasdaq_data['dec_stocks_pct']}%")
  i3.markdown(f"⚪ **Unchanged:** {nasdaq_data['unch_stocks_pct']}%")
